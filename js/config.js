...
export const CONFIG = {
  ...
  accounts: [
    { side: 'groom', label: '신랑', bank: '토스뱅크', number: '1000-0892-5960', holder: '이진욱' },
    { side: 'groom', label: '아버지', bank: 'KB국민은행', number: '837601-04-108455', holder: '이춘목' },
    { side: 'groom', label: '어머니', bank: 'IBK기업은행', number: '149-00606-703-018', holder: '이미경' },
    { side: 'bride', label: '신부', bank: '카카오뱅크', number: '7942-29-07510', holder: '이세라' },
    { side: 'bride', label: '아버지', bank: '농협은행', number: '352-0522-4538-53', holder: '이종재' },
    { side: 'bride', label: '어머니', bank: '우체국', number: '100479-02-168060', holder: '이미애' }
  ],
  photos: [
