...
export const CONFIG = {
  ...
  photos: [
    { id: 1, src: './assets/photos/photo-01.jpg', alt: '노란 꽃다발과 반지 상자를 든 두 사람' },
    { id: 2, src: './assets/photos/photo-02.jpg', alt: '색색의 리본 속에서 웃는 두 사람' },
    { id: 3, src: './assets/photos/photo-03.jpg', alt: '하트 풍선을 들고 서로 바라보는 두 사람' },
    { id: 4, src: './assets/photos/photo-04.jpg', alt: '거울 앞에서 컵케이크를 든 두 사람' },
    { id: 5, src: './assets/photos/photo-05.jpg', alt: '노란 꽃다발을 든 신부와 반지 상자를 든 신랑' },
    { id: 6, src: './assets/photos/photo-06.jpg', alt: '거울에 결혼 날짜를 쓰는 두 사람' },
    { id: 7, src: './assets/photos/photo-07.jpg', alt: '흰 꽃다발을 든 신부의 모습을 담는 신랑' },
    { id: 8, src: './assets/photos/photo-08.jpg', alt: '선글라스와 레이스를 맞춰 쓴 두 사람' },
    { id: 9, src: './assets/photos/photo-09.jpg', alt: '검은 턱시도 차림으로 꽃다발을 든 신랑' },
    { id: 10, src: './assets/photos/photo-10.jpg', alt: '붉은 리본을 나란히 든 신랑과 신부' },
    { id: 11, src: './assets/photos/photo-11.jpg', alt: '컵케이크를 들고 눈을 맞추는 두 사람' },
    { id: 12, src: './assets/photos/photo-12.jpg', alt: '흰 소파에 앉아 미소 짓는 신부' },
    { id: 13, src: './assets/photos/photo-13.jpg', alt: '창가에서 서로를 바라보는 두 사람' },
    { id: 14, src: './assets/photos/photo-14.jpg', alt: '하트 풍선을 들고 손을 잡은 두 사람' },
    { id: 15, src: './assets/photos/photo-15.jpg', alt: '12와 19 숫자 풍선을 든 두 사람' }
  ],
  treasures: {
  ...
  text: {
    ...
    symbolic: '만남과 프러포즈는 두 사람의 이야기를 담은 상징적인 장면입니다.'
  }
};
